...
const report = {
  stage: 6,
  scope: 'pinned production dependencies, native SQLite, workerd, Nuxt builds, browser authentication/contact workflows and release gates',
...
if (report.blockers.length) {
  ...
  const commands = [
    'verify:stage6:offline','typecheck:stage6','typecheck:database','test:database:native','test:database:workerd',
    'typecheck','lint','test:unit','build:ubuntu','smoke:ubuntu','build:cloudflare','smoke:cloudflare','test:e2e',
  ]

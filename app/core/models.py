...
TABLES: tuple[Table, ...] = (
    ...
    Table(
        ...
        (
            ...
            Field("highlight_gbt", "GB/T 高亮作者"),
            Field("highlight_elsevier", "Elsevier 高亮作者"),
            Field("highlight_apa", "APA 高亮作者"),
            Field("highlight_ieee", "IEEE 高亮作者"),
            Field("publication_type", "论文类型", list=True, search=True),
            Field("author_role", "作者角色", "select", choices=("", "first", "corresponding", "other")),
            Field("corresponding_authors", "通讯作者", search=True),

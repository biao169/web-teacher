# app / pages / en / students / [uid].vue

## 文件定位

- **源码路径**：`app/pages/en/students/[uid].vue`
- **文件类型**：页面
- **功能定位**：公开站页面入口，对应路由 /en/students/:uid；负责获取页面数据、设置 SEO 并渲染内容组件。
- **规模**：14 行，578 字节
- **内容校验**：SHA-256 `122ff2a7d4b2b10a66f8f1b830a42b6923f7f6d93b27c533613259ddcb1568a6`
- **页面路由**：`/en/students/:uid`

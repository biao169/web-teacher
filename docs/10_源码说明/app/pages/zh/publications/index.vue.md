# app/pages/zh/publications/index.vue

## 文件定位

- **源码路径**：`app/pages/zh/publications/index.vue`
- **功能定位**：双语论文或精选论文页：先读取轻量列表，再await当前格式有界批次完成SSR；共用SEO、重读与reactive数据。
- **规模**：10 行，775 字节
- **内容校验**：SHA-256 `076de5366665974872edeff9461c1e0283148b8460aad83f129a8e977cd74944`

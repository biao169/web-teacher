...
const report = {
  stage: 2,
  scope: 'pinned production dependencies, native SQLite, workerd, Nuxt and browser-facing release gates',
...
for (const name of [
  'typescript', 'vitest', 'nuxt', 'h3', 'zod', 'nuxt-security',

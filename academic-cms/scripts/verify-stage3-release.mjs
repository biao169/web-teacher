...
const report = {
  stage: 3,
  scope: 'pinned production dependencies, native SQLite, workerd, Nuxt and lint/unit release gates; runtime/browser acceptance is chained by acceptance:stage3',

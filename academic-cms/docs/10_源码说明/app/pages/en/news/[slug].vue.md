# app / pages / en / news / [slug].vue

## 文件定位

- **源码路径**：`app/pages/en/news/[slug].vue`
- **文件类型**：页面
- **功能定位**：公开站页面入口，对应路由 /en/news/:slug；负责获取页面数据、设置 SEO 并渲染内容组件。
- **规模**：14 行，566 字节
- **内容校验**：SHA-256 `e6b0af0d1b7d53a1743e560ae3cf2e6fbb991a493b07d1d819622c82bf0db494`
- **页面路由**：`/en/news/:slug`

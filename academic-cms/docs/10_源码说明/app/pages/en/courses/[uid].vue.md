# app / pages / en / courses / [uid].vue

## 文件定位

- **源码路径**：`app/pages/en/courses/[uid].vue`
- **文件类型**：页面
- **功能定位**：公开站页面入口，对应路由 /en/courses/:uid；负责获取页面数据、设置 SEO 并渲染内容组件。
- **规模**：14 行，574 字节
- **内容校验**：SHA-256 `23432be62e73a1b216a6e0fdbb3a92b7c4f3fd01e5ced8eff15c65bb9a372f56`
- **页面路由**：`/en/courses/:uid`

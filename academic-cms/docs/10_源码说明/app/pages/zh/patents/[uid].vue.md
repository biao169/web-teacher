# app / pages / zh / patents / [uid].vue

## 文件定位

- **源码路径**：`app/pages/zh/patents/[uid].vue`
- **文件类型**：页面
- **功能定位**：公开站页面入口，对应路由 /zh/patents/:uid；负责获取页面数据、设置 SEO 并渲染内容组件。
- **规模**：14 行，574 字节
- **内容校验**：SHA-256 `6f3a80b13fdc520ec1a07db9ca94cee86644c0a70158ed6ac30ba526eb8083b3`
- **页面路由**：`/zh/patents/:uid`

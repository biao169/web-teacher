# app/pages/zh/publications/featured/index.vue

## 文件定位

- **源码路径**：`app/pages/zh/publications/featured/index.vue`
- **功能定位**：双语论文或精选论文页：先读取轻量列表，再await当前格式有界批次完成SSR；共用SEO、重读与reactive数据。
- **规模**：10 行，784 字节
- **内容校验**：SHA-256 `ad5195fd125f6f784bc3cbadd2b3e26d1028aae0a223fb88ac6184b82de3d64b`
